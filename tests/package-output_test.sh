...
printf 'scheduled backup apk fixture\n' > "$tmp/work/sdk/bin/packages/base/luci-app-scheduled-backup-1.0.0-r1.apk"
...
[ -f "$tmp/outputs/luci-app-scheduled-backup_1.0.0-r1_x86_64.apk" ] || {
	echo 'scheduled-backup APK was not published to outputs' >&2
	exit 1
}
grep -Fq 'luci-app-scheduled-backup_1.0.0-r1_x86_64.apk' \
